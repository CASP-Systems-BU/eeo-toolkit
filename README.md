...
7.**Figure Generation** – Consumes the differentially private tables to produce publication-ready charts and summary tables.
...
| Figure Generation   | Matplotlib       | Bar charts, pie charts, and summary tables from DP output            |
...
| Handler           | `eeo1_handler.py`        | `eeo4_handler.py`                              | `eeo5_handler.py`                  |
| Melt              | `eeo1_melt.py`           | `eeo4_melt.py`                                 | `eeo5_melt.py`                     |
| Differential Privacy | `eeo1_dp.py`          | `eeo4_dp.py`                                   | —                                  |
| Figure Generation | `eeo1_figure_generation.py` | `eeo4_figure_generation.py`                 | —                                  |

Filter scripts live under `ocr/postprocess/`. Handler, melt, and DP scripts live under `data_aggregation/`. Figure generation scripts live under `figure_generation/`.
...
Since the EEO-1, EEO-4, and EEO-5 forms are structured and have a complex layout, and we only have CPU resources, we chose to use **DocTR** for the OCR engine.
